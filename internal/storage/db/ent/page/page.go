...
const (
	...
	// EdgePageSource holds the string denoting the page_source edge name in mutations.
	EdgePageSource = "page_source"
	// Table holds the table name of the page in the database.
	Table = "page"
	// PageSourceTable is the table that holds the page_source relation/edge.
	PageSourceTable = "page_source"
	// PageSourceInverseTable is the table name for the PageSource entity.
